...
wake_agent() {
  ...
  msg="Lavish feedback ($n item(s)) on $FILE - read $FEEDBACK, apply the changes, then acknowledge in-browser with: $SCRIPT_DIR/fm lavish-reply \"$FILE\" \"<message>\" (do NOT run 'lavish-axi poll' yourself - the steward owns it)"
