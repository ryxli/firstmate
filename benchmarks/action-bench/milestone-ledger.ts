...
export function macroFor(payload: RunPayload, id2tier: Map<string, string>): ModelMacro {
...
export function recordToJsonl(rec: MilestoneRecord): string {
...
export function renderSection(rec: MilestoneRecord): string {
	const seg = [
