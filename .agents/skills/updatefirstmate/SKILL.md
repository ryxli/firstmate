...
Firstmate is its own repo, shipped directly to `main`, so new tracked material (AGENTS.md, bin/, skills) reaches `main` and then sits there until each running firstmate pulls it.
