...
FM_HOME="$TMP_ROOT/home" FM_STATE_OVERRIDE="$TMP_ROOT/home/state" HOME="$TMP_ROOT/user" "$SCRIPT_DIR/fm-cron-drop.sh" list >"$TMP_ROOT/list-empty.out"
case "$(cat "$TMP_ROOT/list-empty.out")" in
  *"cron-drop: no drops"*) pass "empty list" ;;
  *) cat "$TMP_ROOT/list-empty.out" >&2; fail "empty list" ;;
esac

FM_HOME="$TMP_ROOT/home" FM_STATE_OVERRIDE="$TMP_ROOT/home/state" HOME="$TMP_ROOT/user" "$SCRIPT_DIR/fm-cron-drop.sh" mode daily >"$TMP_ROOT/mode-daily.out"
...
FM_HOME="$TMP_ROOT/home" FM_STATE_OVERRIDE="$TMP_ROOT/home/state" HOME="$TMP_ROOT/user" "$SCRIPT_DIR/fm-cron-drop.sh" list >"$TMP_ROOT/list-remembered.out"
...
FM_HOME="$TMP_ROOT/other-home" FM_STATE_OVERRIDE="$TMP_ROOT/other-home/state" HOME="$TMP_ROOT/user" "$SCRIPT_DIR/fm-cron-drop.sh" list >"$TMP_ROOT/list-forgotten.out"
...
FM_HOME="$TMP_ROOT/home" FM_STATE_OVERRIDE="$TMP_ROOT/home/state" HOME="$TMP_ROOT/user" "$SCRIPT_DIR/fm-cron-drop.sh" reconcile --dry-run >"$TMP_ROOT/reconcile.out"
...
FM_HOME="$TMP_ROOT/home" FM_STATE_OVERRIDE="$TMP_ROOT/home/state" HOME="$TMP_ROOT/user" "$SCRIPT_DIR/fm-cron-drop.sh" mode off >"$TMP_ROOT/mode-off.out"
...
FM_HOME="$TMP_ROOT/home" FM_STATE_OVERRIDE="$TMP_ROOT/home/state" HOME="$TMP_ROOT/user" "$SCRIPT_DIR/fm-cron-drop.sh" reconcile --dry-run >"$TMP_ROOT/reconcile-disabled.out"
...
JSON
if FM_HOME="$TMP_ROOT/bad" FM_STATE_OVERRIDE="$TMP_ROOT/bad/state" HOME="$TMP_ROOT/user" "$SCRIPT_DIR/fm-cron-drop.sh" list >"$TMP_ROOT/bad.out" 2>"$TMP_ROOT/bad.err"; then
