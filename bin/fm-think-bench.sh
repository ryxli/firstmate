...
#
#   bin/fm-think-bench.sh check-corpus
#   bin/fm-think-bench.sh grade <oracle.json> <output-file>
#   bin/fm-think-bench.sh replay <runs.json> --out DIR
#   bin/fm-think-bench.sh record --live      # live; costs tokens
set -euo pipefail
